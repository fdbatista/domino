...
namespace ControlDomino
{
	partial class frmGrupoElite
	{
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmGrupoElite));
			...
			this.lstJugadores.TabIndex = 31;
			this.lstJugadores.UseCompatibleStateImageBehavior = false;
			this.lstJugadores.View = System.Windows.Forms.View.Details;
			this.lstJugadores.KeyDown += new System.Windows.Forms.KeyEventHandler(this.FrmGrupoEliteKeyDown);
			// 
			// columnHeader1
			// 
			...
			this.imgOff.Location = new System.Drawing.Point(323, 62);
			this.imgOff.Name = "imgOff";
			this.imgOff.Size = new System.Drawing.Size(132, 133);
			this.imgOff.SizeMode = System.Windows.Forms.PictureBoxSizeMode.Zoom;
			this.imgOff.TabIndex = 33;
			...
			this.cmbTorneo.TabIndex = 75;
			this.cmbTorneo.SelectedIndexChanged += new System.EventHandler(this.CmbTorneoSelectedIndexChanged);
			this.cmbTorneo.KeyDown += new System.Windows.Forms.KeyEventHandler(this.FrmGrupoEliteKeyDown);
			// 
			// label6
			// 
			...
			this.Name = "frmGrupoElite";
			this.Text = "Grupo élite";
			this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.FrmGrupoEliteFormClosing);
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.FrmGrupoEliteKeyDown);
